...
python3 main.py  --dataset ${_dataset} --num_classes 10 --epochs 2000  --num_users 20 --local_ep 5 --local_bs 100 --train_num 500 --test_num 100 --lr ${_lr} \
        ...
        --global_test_data_num 1000 \
        --gpu ${_gpu} \
        --name ${_dataset}_alpha_${_alpha}_P_${_policy}_M${_model_num}_

#
#bash run.sh cifar10 2 100 0 0.01 5&
#bash run.sh cifar10 2 100 0 0.01 2&
#bash run.sh cifar10 2 100 0 0.01 1&
#bash run.sh cifar10 2 1 1 0.01 5&
#bash run.sh cifar10 2 1 1 0.01 2&
#bash run.sh cifar10 2 1 1 0.01 1&
#bash run.sh cifar10 2 0.1 2 0.01 5&
#bash run.sh cifar10 2 0.1 2 0.01 2&
#bash run.sh cifar10 2 0.1 2 0.01 1
