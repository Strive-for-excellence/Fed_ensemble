...
_lr=${5:-0.01}
_model_num=${6:-1}
echo python3 main.py  --dataset ${_dataset} --num_classes 10 --epochs 2000  --num_users 20 --local_ep 2 --local_bs 100 --train_num 500 --test_num 100 --lr ${_lr}  \
        --policy ${_policy}   \
...
python3 main.py  --dataset ${_dataset} --num_classes 10 --epochs 2000  --num_users 20 --local_ep 2 --local_bs 100 --train_num 500 --test_num 100 --lr ${_lr} \
        --policy ${_policy}   \
        --iid 0 --noniid dirichlet --alpha ${_alpha}  \
        --model_num ${_model_num} --model_num_per_client ${_model_num} \
        --global_test_data_num 1000 \
